<?php
  ...
  $objGeo->infoParroquia($parroquia);
  ...
  $objPun->tip_id=$tipId;
  $objPun->prov_id=$objGeo->prov_id;
  $objPun->can_id=$objGeo->can_id;
  $objPun->parr_id=$objGeo->parr_id;
  
  $objPun->pun_nombre=$objGeo->geo_nombre;
  $objPun->pun_descripcion="Parroquia: ".$objGeo->geo_nombre;
