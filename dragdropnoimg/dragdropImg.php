...
<div id="contratados" class="seccion" style="float:left;width:150px;">
	...
	<div id="provincia"><img src="../icono/provincia.gif" id="provincia" /></div>
	<div id="canton"><img src="../icono/canton.gif" id="canton" /></div>
	<?php 
...
<div id="despedidos" class="seccion" style="float:left;width:150px;">
	...
	<div id="utd"><img src="../icono/utd.gif" id="utd" /></div>
	<?php 
